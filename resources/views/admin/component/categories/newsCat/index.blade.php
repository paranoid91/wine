...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <a href="{{ action('Admin\NewsCatController@create') }}" class="btn btn-success right"><i class="fa fa-plus"></i> {{trans('admin.add')}}</a><div class="fix"></div>
    </div>
    <div class="panel-body">
        <table class="table table-hover">
            ...
            <tbody id="sections">
                  {{parseAndPrintTree($categories,$cat,0,'NewsCatController')}}
            </tbody>
        </table>
        <tfoot>
        <tr>
