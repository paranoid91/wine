...
function create_folder($path = null, $path_thumbs = null)
{
	...
	if ($path_thumbs && ! file_exists($path_thumbs))
	{
		...
		$path_300 = str_replace('thumbs/','thumbs/300/',$path_thumbs);
		if ($path_300 && ! file_exists($path_300))
		{
			mkdir($path_300, 0766, true) or die("$path_thumbs cannot be found");
		} // or even 01777 so you get the sticky bit set
	} // or even 01777 so you get the sticky bit set
	umask($oldumask);
}
...
* @return  bool
*/
function fendsWith($haystack, $needle)
{
